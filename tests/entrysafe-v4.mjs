...
for(const token of ['VERSION="4.0.1-20260830"','evaluate-trip-selection-v3','pendingQuestions','trip_declaration_snapshots_v4','allowed_declare','rawItems.length>1000','rawItems.length===0','getUser(token)'])assert.ok(engine.includes(token),`Missing V4 engine capability ${token}`);
