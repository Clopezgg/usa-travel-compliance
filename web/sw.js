const CACHE='entrysafe-v3-checklist-20260830';
const ASSETS=['./','./index.html','./entrysafe-v3.css','./entrysafe-v3.js','./catalog-v3.js','./supabase-local.js','./config.js','./manifest.webmanifest','./icon.svg'];
