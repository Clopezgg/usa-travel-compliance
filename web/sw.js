const CACHE='entrysafe-v2-premium-20260830';
const ASSETS=['./','./index.html','./entrysafe-v2.css','./entrysafe-v2.js','./supabase-local.js','./config.js','./manifest.webmanifest','./icon.svg'];
