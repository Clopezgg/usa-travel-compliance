const CACHE='entrysafe-shell-v2';
const ASSETS=['./','./index.html','./styles.css','./premium-base.css','./premium-components.css','./premium-mobile.css','./app.js','./config.js','./manifest.webmanifest','./icon.svg'];
